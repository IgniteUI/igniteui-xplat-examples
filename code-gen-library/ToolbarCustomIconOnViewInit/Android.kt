//begin imports
import com.infragistics.mobile.controls.SvgIconRegistry
import com.infragistics.mobile.controls.IgaToolbar
//end imports

class ToolbarCustomIconOnViewInit {

    //begin eventHandler
    //Kotlin: Action
    fun toolbarCustomIconOnViewInit() {
        val icon = """
        ...
        val toolbar = CodeGenHelper.getDescription<IgaToolbar>("aboveContentLeft")
