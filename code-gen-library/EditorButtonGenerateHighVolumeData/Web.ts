...
export class EditorButtonGenerateHighVolumeData {

    //begin eventHandler
    public editorButtonGenerateHighVolumeData(sender: any, args: IgcPropertyEditorPropertyDescriptionButtonClickEventArgs): void {
