...
export class WebGridChangeOnYearPercentTemplateComponent {
...
@NgModule({
    bootstrap: [],
    declarations: [
        WebGridChangeOnYearPercentTemplateComponent
    ],
    imports: [
      BrowserModule,
...
export class WebGridChangeOnYearPercentTemplateModule {
