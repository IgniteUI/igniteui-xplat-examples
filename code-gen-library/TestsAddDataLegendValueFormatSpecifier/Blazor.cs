...
public class TestsAddDataLegendValueFormatSpecifier
{
    ...
    public  void TestsAddDataLegendValueFormatSpecifier(){
		...
		// JSON string), and CodeGenHelper.FindByName<T> does a direct (T) cast -- so <JValue> (Newtonsoft)
		// and <string> both throw InvalidCastException. Ask for the JsonDictionaryValue and read .Value.
		...
		legend.ValueFormatSpecifiers.Add(numSpec);
    }	
    //end eventHandler
