...
public class WebGridHasSummariesChange
{
    ...
    public void WebGridHasSummariesChange(IgbPropertyEditorPropertyDescriptionChangedEventArgs args)
    {
        ...
        var column1 = CodeGenHelper.GetDescription<IgbGrid>("content").GetColumns().ElementAt(3);
        var column2 = CodeGenHelper.GetDescription<IgbGrid>("content").GetColumns().ElementAt(5);
