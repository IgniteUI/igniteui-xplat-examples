...
{
    //begin eventHandler
    public void BulletGraphAnimateToGauge1(IgbPropertyEditorPropertyDescriptionButtonClickEventArgs args)
    {
        ...
        gauge.Ranges.Clear();
        gauge.Ranges.Add(new IgbLinearGraphRange { StartValue = 0,  EndValue = 40, Brush = "#A4BD29", Outline = "#A4BD29", InnerStartExtent = 0.2, InnerEndExtent = 0.2, OuterStartExtent = 0.95, OuterEndExtent = 0.95 });
        gauge.Ranges.Add(new IgbLinearGraphRange { StartValue = 40, EndValue = 80, Brush = "#F86232", Outline = "#F86232", InnerStartExtent = 0.2, InnerEndExtent = 0.2, OuterStartExtent = 0.95, OuterEndExtent = 0.95 });
    }
    //end eventHandler
}
